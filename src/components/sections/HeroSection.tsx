...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden py-12 md:py-24 bg-gradient-to-b from-background to-background/80">
      ...
      <div className="container z-10">
        ...
        <ScrollAppear className="w-full max-w-2xl mx-auto mb-12 text-center" delay="delay-400">
           <p className="font-body text-lg md:text-xl text-muted-foreground mb-6">{t('skills.intro')}</p>
